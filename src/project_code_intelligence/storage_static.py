...
if TYPE_CHECKING:
    from project_code_intelligence.models import Snapshot, StaticRun
...
def insert_static_runs(
    ...
    *,
    ...
    for run in runs:
        ...
        run_id = row_int(db.require_row(row, "insert static run"), "id")
        ...
        for finding in run.findings:
            ...
            finding_id = row_int(db.require_row(finding_row, "insert static finding"), "id")
            ...
            for step in finding.code_flows:
                ...
                counts["static_code_flow_steps"] += 1
    return counts
