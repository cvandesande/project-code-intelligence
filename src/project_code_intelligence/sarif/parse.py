...
from project_code_intelligence.sarif.paths import SarifPathContext, resolve_sarif_source_path

if TYPE_CHECKING:
    from project_code_intelligence.sarif.types import SarifResultContext, SarifToolMetadata
