...
def semantic_distance_penalty(args: Json, query: str, penalty: float, *, require_implementation: bool = False) -> float:
...
def semantic_structural_symbol_distance_penalty(args: Json, query: str) -> float:
    return semantic_distance_penalty(
        args, query, SEMANTIC_STRUCTURAL_SYMBOL_DISTANCE_PENALTY, require_implementation=True
    )


def semantic_validation_distance_penalty(args: Json, query: str) -> float:
    return semantic_distance_penalty(args, query, SEMANTIC_VALIDATION_DISTANCE_PENALTY, require_implementation=True)


def semantic_generated_distance_penalty(args: Json, query: str) -> float:
    return semantic_distance_penalty(args, query, SEMANTIC_GENERATED_DISTANCE_PENALTY)


def semantic_non_source_distance_penalty(args: Json, query: str) -> float:
    return semantic_distance_penalty(args, query, SEMANTIC_NON_SOURCE_DISTANCE_PENALTY)
